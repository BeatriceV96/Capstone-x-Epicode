...
namespace NovaVerse.Migrations
{
    ...
    [Migration("20241211150739_AddNotificationsAndMessages")]
    partial class AddNotificationsAndMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovaVerse.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NovaVerse.Models.Message", b =>
                {
                    b.HasOne("NovaVerse.Models.User", null)
                        .WithMany()
